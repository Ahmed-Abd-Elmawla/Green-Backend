...
namespace App\Http\Controllers\Dashboard\AccountStatement;
...
class AccountStatementController extends Controller
{
    ...
    {
        $clients = Client::all();
        $clientsData = ClientMiniResource::collection($clients);
        return view('pages.AccountStatement.accountStatement', compact('clientsData'));
    }
